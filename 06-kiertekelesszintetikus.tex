...
\begin{table}[h]\centering
    ...
    Csészelevél hossz     & 5.45, 6.15 & 0.95   \\
    Csészelevél szélesség & 2.95, 3.35 & 0.35   \\
    Sziromlevél hossz     & 2.45, 4.75 & 0.32   \\
    Sziromlevél szélesség & 0.8, 1.75  & 1.59
    \end{tabular}
...
\emph{E, B, D, A, C}
A véletlenszerű topológiai sorrendekből az algoritmus szerint a \emph{E, B, D, A, C} bizonyult a legjobbnak.