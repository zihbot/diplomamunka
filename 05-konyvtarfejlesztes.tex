...
A \emph{preference\_bias} a k2 algoritmust pontozó algoritmus. A pontszámot ez az \emph{f} függvény adja, amint a \ref{chapter:bayesdontesalapu}. fejezetben ki van fejtve:
$$ f(i, \pi_{i}) =
...
$$ ln(n!) = ln(\Gamma(n + 1))$$
Ennek segítségével a scikit-learn \emph{gammaln} \footnote{https://docs.scipy.org/doc/scipy/reference/generated/scipy.special.gammaln.html} függvénye is használható. Ez pedig a numpy mátrixokon sokkal nagyobb sebességgel képes a műveletet elvégezni, mint egy elemenkénti megvalósítás \cite{smith2015cython}.
