...
\subsection{Támogatottsági követelmények}
    Tesztelhetőségi, konfiurálhatósági, bővítési lehetőségekre ír le igényeket.
...
\begin{enumerate}[resume]
    ...
    \descitem{Beállítható változó típus} Legyen megadható a bemeneti változók típusa (folyatonos és diszkrét)
