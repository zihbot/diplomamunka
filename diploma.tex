...
\pagestyle{plain}
%\setlength{\parindent}{0pt} % áttekinthetőbb, angol nyelvû dokumentumokban jellemzõ
...
%Diszkretizáció stastisztikai módszerei - Egyváltozós, többváltozós
\include{04-bayesdontesalapu}
%Implementáció, dokumentáció
\include{05-konyvtarfejlesztes}
%Tesztelés szintetikus adatokon - képek a bemeneti adatokhoz, implementálás
